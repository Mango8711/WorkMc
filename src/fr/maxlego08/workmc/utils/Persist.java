...
public class Persist {
	...
	public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
		if (!file.exists()) {
			System.out.println("[Oldfight] Creating default: " + file);
			this.save(def, file);
			return def;
		}
		...
		if (loaded == null) {
			System.out.println("[Oldfight] Using default as I failed to load: " + file);
			/*
			...
			if (backup.exists())
				backup.delete();
			System.out.println("[Oldfight] Backing up copy of bad file to: " + backup);
			file.renameTo(backup);

			return def;
		} else {

			System.out.println("[Oldfight] " + file.getAbsolutePath() + " loaded successfully !");
